      ...
      <div className="container mx-auto px-4 relative z-10 py-16 md:py-24">
        <div className="max-w-3xl fade-up-stagger">
          ...
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-display font-bold text-white mb-6">
            Growing a <span className="text-argos-green">Sustainable</span> Future for Agriculture
          </h1>
          
          <p className="text-xl text-white/80 mb-8">
            Argos Industries Ltd provides innovative agricultural solutions that enhance productivity while preserving our natural resources for future generations.
          </p>
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-white">
            <div className="flex items-center justify-center md:justify-start">
              ...
              <div>
                <h4 className="font-semibold text-lg">Industry Leader</h4>
                <p className="text-white/70">Trusted by farmers worldwide</p>
              </div>
            </div>
            <div className="flex items-center justify-center">
              <Leaf className="h-8 w-8 mr-3 text-argos-green animate-leaf-sway" />
              <div>
                <h4 className="font-semibold text-lg">Eco-Friendly Products</h4>
                <p className="text-white/70">Sustainable agricultural solutions</p>
              </div>
            </div>
            <div className="flex items-center justify-center md:justify-end">
              <Clock className="h-8 w-8 mr-3 text-argos-green" />
              <div>
                <h4 className="font-semibold text-lg">25+ Years</h4>
                <p className="text-white/70">Of agricultural innovation</p>
              </div>
            </div>
          </div>
        </div>
